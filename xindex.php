...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-card-8 w3-animate-top">
    ...
    <div class="w3-container">
      ...
      <p><a href="reportingincidenceformyself.php">Click to Report Incident For Yourself</a></p>
    </div>
  ...
  <div class="w3-modal-content w3-card-8 w3-animate-top">
    ...
    <div class="w3-container">
     <p> &#8212; Know that the sexual violence wasn't your fault
      ...
      <p><a class="w3-btn" href="http://52.43.152.73/reportingincidencefrd.php">Click to Report Incident For a Friend</a></p>
    </div>
    <footer class="w3-container w3-cyan">
      <p><h5><b>We are Willing To Help You</b></h5></p>
    </footer>
